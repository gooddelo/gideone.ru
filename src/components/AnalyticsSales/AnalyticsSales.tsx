    ...
    <DragBlock className={cn(styles.drag_block)}>
      ...
      <div className={cn(styles.block, styles.third)}>
        ...
        <div className={styles.third__images}>
          <Image src={t('dashboards.img_1')} width={1144} height={425} alt={t('dashboards.name')} />
          <Image src={t('dashboards.img_2')} width={1616} height={425} alt={t('dashboards.name')} />
          <Image src={t('dashboards.img_3')} width={1844} height={425} alt={t('dashboards.name')} />
          <Image src={t('dashboards.img_4')} width={1876} height={420} alt={t('dashboards.name')} />
          <Image src={t('dashboards.img_5')} width={1140} height={420} alt={t('dashboards.name')} />
          <Image src={t('dashboards.img_6')} width={1568} height={420} alt={t('dashboards.name')} />
        </div>
      </div>
